    ...
    >
      ...
      <Link href={`/projects/${project.slug}`}>
        <a className="block">
          ...
          <div className="p-4">
            <h3 className="font-heading font-bold text-base mb-1 truncate">{project.title}</h3>
            ...
            <div className="mb-2">
              <div className="flex justify-between text-xs mb-1">
                ...
                <span className="font-medium">{project.currentFunding} {project.fundingCurrency}</span>
              </div>
