...
export default function HowItWorks() {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Share your project and engage with the global community of potential backers."
    },
    {
      number: 4,
      icon: <Rocket className="h-6 w-6 text-primary" />,
      title: "Build & Deliver",
      description: "As milestones are reached, smart contracts release funds automatically to continue development."
    }
  ];
