...
export default function HeroSection() {
      ...
      try {
        if (typeof window !== "undefined") {
          ...
          if (
            ...
            // Floating animation - gentle bobbing for first element
            ...
            // Floating animation for second element
            ...
            // Floating animation for third element
  ...
  return (
    <section
      ref={sectionRef}
      className="animated-bg pt-28 md:pt-32 pb-12 md:pb-20"
    >
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          >
            ...
            <p className="text-slate-700 dark:text-slate-300 text-lg md:text-xl mb-8 font-medium">
              Frami helps bring creative projects to life with transparency,
              security, and global access through blockchain technology.
            </p>
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="border border-primary text-primary hover:bg-primary hover:text-white font-medium rounded-lg"
              >
          ...
          <div ref={imageRef} className="w-full md:w-1/2 relative">
            <div className="relative rounded-xl overflow-hidden shadow-xl bg-gradient-to-r from-[#130F40] to-[#000428] border border-primary/20 max-w-[720px] w-full mx-auto">
              ...
              <div className="pt-16 pb-12 px-10 relative">
                ...
                <div className="flex flex-col items-center relative z-10">
                  ...
                  <div className="flex justify-between items-center w-full mb-2">
                    {/* Minted count */}
                    <div className="bg-black/30 px-3 py-1.5 rounded-md text-white text-sm font-medium">
                      <span className="text-primary font-bold">750</span>
                      <span className="opacity-80">/1000</span> Minted
                    </div>
                  </div>

                  {/* Limited Availability Tag - Centered */}
                  <div className="mb-6">
                    <div className="bg-primary/10 px-4 py-1.5 rounded-full text-primary uppercase text-xs font-medium inline-block">
                  ...
                  <div className="flex flex-col md:flex-row items-center md:items-start mb-6">
                    ...
                    <div className="text-center md:text-left">
                      ...
                      <Button
                        asChild
                        size="default"
                        className="bg-primary hover:bg-primary/90 text-white font-medium rounded-md shadow-lg px-6"
                      >
            ...
            <div
              ref={floatingRef1}
              className="absolute top-6 -right-8 bg-white dark:bg-slate-800 p-4 rounded-lg shadow-xl rotate-3 hidden md:block z-20"
            >
            ...
            <div
              ref={floatingRef2}
              className="absolute bottom-20 -left-8 bg-white dark:bg-slate-800 p-4 rounded-lg shadow-xl -rotate-3 hidden md:block z-20"
            >
              <div className="flex items-center space-x-3">
                <div className="bg-secondary/10 dark:bg-secondary/20 p-2.5 rounded-full">
                  <svg
            ...
            {/* Additional floating card for Early Access */}
            <div
              ref={floatingRef3}
              className="absolute top-1/2 -translate-y-1/2 -right-12 bg-white dark:bg-slate-800 p-4 rounded-lg shadow-xl rotate-6 hidden md:block z-20"
            >
              <div className="flex items-center space-x-3">
                <div className="bg-teal-500/10 dark:bg-teal-500/20 p-2.5 rounded-full">
                  <svg
