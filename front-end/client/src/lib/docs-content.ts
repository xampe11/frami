    ...
    items: [
      {
        ...
        content: [
          ...
          { type: 'heading', title: 'Target audience' },
          { type: 'list', items: [
            "Project Creators: Entrepreneurs, innovators, and visionaries looking to bring their creative ideas to life with blockchain-backed funding.",
            "Investors: Web3 enthusiasts and backers wanting to support innovative projects while potentially earning returns on their investments.",
            "Developers: Technical contributors looking to build extensions or integrate with our platform."
          ]},
          ...
          { type: 'note', title: 'New to blockchain?', text: 'Don\'t worry if you\'re new to blockchain technology. Our platform is designed to be user-friendly while leveraging the benefits of blockchain. You\'ll find helpful guides throughout the documentation to get you up to speed.' }
        ]
      },
      {
        ...
        content: [
          { type: 'heading', title: 'Step-by-step guide to create your first project' },
          ...
          { type: 'warning', title: 'Important Note', text: 'Always ensure you\'re connected to the correct wallet address when backing projects or creating new initiatives. Transactions on the blockchain are irreversible.' }
        ]
      },
      {
...
│      (RainbowKit/Wagmi, Web3.js)        │
└───────────────┬─────────────────────────┘
                │
    ┌───────────▼───────────┐     ┌────────────────────────┐
    │   Smart Contracts     │     │    Backend Services    │
    │ (Project, Milestones, ├─────┤   (Express, Drizzle)   │
    │    Tokens, Voting)    │     │                        │
    └───────────┬───────────┘     └────────────────────────┘
                │
    ┌───────────▼───────────┐
    ...
    └─────────────────────────────────────────────────────┘` },
          ...
          { type: 'list', items: [
            ...
            "Blockchain Integration: Connects user actions to blockchain transactions using RainbowKit/Wagmi and Web3.js libraries.",
          ...
          { type: 'table', headers: ['Term', 'Definition'], rows: [
            ['Project', 'A creative initiative seeking funding on the platform. Each project has specific goals, milestones, and funding requirements.'],
            ['Milestone', 'A defined checkpoint in a project\'s development, with specific deliverables that, when verified, trigger the release of a portion of funds.'],
            ['Smart Contract', 'Self-executing code on the blockchain that enforces and automates the rules of project funding and milestone verification.'],
            ['Gas Fee', 'A small fee paid to the blockchain network for processing transactions. Required for operations like backing a project or releasing milestone funds.'],
            ['Wallet', 'A digital tool that stores your cryptocurrency and allows you to interact with blockchain applications.'],
            ['FounderNFT', 'Non-fungible tokens that represent exclusive membership and benefits on the Frami platform.'],
            ['Governance', 'The process by which project backers can participate in voting on milestone completion and other key decisions.']
          ]}
        ]
      }
    ]
    ...
    items: [
      {
        ...
        content: [
          { type: 'heading', title: 'UUPS (Universal Upgradeable Proxy Standard) explained' },
          ...
          { type: 'warning', title: 'Development Note', text: 'When creating custom extensions, always follow the storage separation pattern to ensure compatibility with future upgrades.' },
    ...
    └── Manages platform membership benefits` }
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'table', headers: ['Extension Type', 'Purpose', 'Core Features'], rows: [
            ['Payment Extensions', 'Handle different payment methods', 'Multiple token support, fiat on-ramps, payment splitting'],
            ['Governance Extensions', 'Enhance project decision-making', 'Custom voting mechanisms, proposal systems, delegation'],
            ['Reward Extensions', 'Manage backer incentives', 'Token distributions, NFT rewards, tiered benefits'],
            ['Verification Extensions', 'Validate milestone completion', 'External data oracles, multi-sig approval, automated checks'],
            ['Integration Extensions', 'Connect to external services', 'GitHub integration, social media connectivity, analytics']
          ]},
          ...
          { type: 'note', title: 'Developer Resources', text: 'For detailed guidance on extension development, refer to the "For Extension Builders" section under Guides.' }
        ]
      },
      {
        ...
        content: [
          ...
          { type: 'table', headers: ['Milestone', 'Deliverables', 'Funding %'], rows: [
            ['Prototype Development', 'Working software prototype with core functionality, GitHub repository, demo video', '20%'],
            ['Beta Release', 'Testable beta version, user documentation, initial user testing results', '30%'],
            ['Launch Preparation', 'Final product, complete documentation, marketing materials, launch plan', '25%'],
            ['Public Launch', 'Live product, user onboarding system, support infrastructure', '25%']
          ]},
          ...
          { type: 'warning', title: 'Important', text: 'Once funds are released for a milestone, the transaction cannot be reversed. This ensures finality on the blockchain but makes the verification process critically important.' }
        ]
      },
      {
        ...
        content: [
          ...
          { type: 'table', headers: ['Role', 'Permissions'], rows: [
            ['Platform Admin', 'Manage platform settings, approve new extension types, execute emergency controls'],
            ['Project Creator', 'Create and manage projects, define milestones, submit verification evidence, receive funds'],
            ['Project Team Member', 'Access based on creator-assigned permissions (view, edit, submit updates)'],
            ['Backer', 'Contribute funds, vote on milestones, receive project updates, participate in governance'],
            ['Verifier', 'Specialized role for validating milestone completion with enhanced voting power']
          ]},
          ...
          { type: 'note', title: 'Roadmap Item', text: 'DAO governance is scheduled for implementation in Phase 3 of our platform roadmap (estimated Q4 2025). Current governance is managed by the founding team with community input.' }
        ]
      }
    ]
  },
    ...
    items: [
      {
        ...
        content: [
          ...
          { type: 'note', title: 'Best Practice', text: 'Many successful projects allocate a smaller percentage (15-20%) to the first milestone to demonstrate commitment and reduce initial risk for backers.' },
          ...
          { type: 'warning', title: 'Important', text: 'Submit milestone completion evidence well before you require funds, as the verification process takes time (typically 3-7 days depending on your project settings).' }
        ]
      },
      {
        id: "for-investors",
        ...
        content: [
          ...
          { type: 'note', title: 'Important', text: 'Refunds are processed automatically by the smart contract when conditions are met. No manual claim is needed in most cases.' }
        ]
      },
      {
        id: "for-developers",
        ...
        content: [
          ...
          { type: 'code', code: `// Example .env file for local development
...
LOCAL_RPC_URL=http://localhost:8545` },
          ...
          { type: 'code', code: `// Example: Using the Frami SDK to get project details
...
async function getProjectDetails(projectId) {
  try {
    ...
    console.error('Error fetching project:', error);
          ...
          { type: 'code', code: `// Example: Running a test for a custom extension
...
describe('MyCustomExtension', function() {
  ...
  it('should correctly integrate with project', async function() {
    ...
    expect(await project.hasExtension(extension.address)).to.be.true;
          ...
          { type: 'warning', title: 'Security Note', text: 'Never store private keys in your application code. Use secure key management solutions and environment variables for sensitive information.' }
        ]
      }
    ]
  },
    ...
    items: [
      {
        ...
        content: [
          ...
          { type: 'table', headers: ['Method/Event', 'Description', 'Parameters'], rows: [
            ['registerExtension', 'Registers a new extension in the platform registry', 'address extension, string name, string category'],
            ['removeExtension', 'Removes an extension from the registry', 'address extension'],
            ['getExtensionsByCategory', 'Returns all extensions in a specific category', 'string category'],
            ['setImplementation', 'Updates the implementation address for a contract type', 'string contractType, address implementation'],
            ['getImplementation', 'Gets the current implementation address for a contract type', 'string contractType'],
            ['ExtensionRegistered', 'Event emitted when a new extension is registered', 'address extension, string name, string category'],
            ['ExtensionRemoved', 'Event emitted when an extension is removed', 'address extension'],
            ['ImplementationUpdated', 'Event emitted when a contract implementation is updated', 'string contractType, address implementation']
          ]},
          
          { type: 'subheading', title: 'Storage structure' },
          { type: 'code', code: `// PlatformRegistry storage layout
...
struct ExtensionInfo {
    ...
    bool active;
          ...
          { type: 'table', headers: ['Parameter', 'Description', 'Validation Rules'], rows: [
            ['name', 'Project display name', 'Non-empty, max 100 characters'],
            ['description', 'Brief project description', 'Max 1000 characters'],
            ['fundingGoal', 'Total funding target', 'Greater than minimum (0.1 ETH)'],
            ['duration', 'Maximum project duration in days', 'Between 1 and 365 days'],
            ['milestones', 'Array of milestone objects', 'At least 1 milestone, total funding % must equal 100'],
            ['category', 'Project category identifier', 'Must be from approved list'],
            ['creator', 'Address of project creator', 'Must be transaction sender or approved delegate']
          ]},
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'table', headers: ['State', 'Description', 'Transitions'], rows: [
            ['Draft', 'Initial creation state, not yet published', 'Can move to Active when published'],
            ['Active', 'Project is published and accepting funds', 'Can move to Successful, Failed, or Canceled'],
            ['Successful', 'Project reached its funding goal and completed all milestones', 'Terminal state'],
            ['Failed', 'Project did not reach minimum funding or failed critical milestone', 'Terminal state'],
            ['Canceled', 'Project was canceled by creator or admin', 'Terminal state']
          ]},
          ...
          { type: 'code', code: `// Example investment flow
function invest() external payable {
    ...
    emit InvestmentReceived(msg.sender, msg.value);
          ...
          { type: 'code', code: `// Simplified milestone verification process
...
function voteOnMilestone(
    ...
    emit MilestoneVoteCast(milestoneIndex, msg.sender, approve, votingPower);
          ...
          { type: 'code', code: `// Simplified fund release process
    ...
    items: [
      {
        ...
        content: [
          ...
          { type: 'code', code: `// Installing the SDK
    ...
    },
    {
      ...
      fundingPercentage: 40
          ...
          { type: 'table', headers: ['Endpoint', 'Method', 'Description'], rows: [
            ['/api/projects', 'GET', 'List all projects with filtering options'],
            ['/api/projects/:id', 'GET', 'Get details of a specific project'],
            ['/api/projects/:id/milestones', 'GET', 'Get milestones for a project'],
            ['/api/projects/:id/backers', 'GET', 'Get backers of a project'],
            ['/api/users/:address/projects', 'GET', 'Get projects created by a user'],
            ['/api/users/:address/investments', 'GET', 'Get investments made by a user'],
            ['/api/stats', 'GET', 'Get platform statistics and metrics']
          ]},
          
          { type: 'code', code: `// Example API request using fetch
async function getProject(projectId) {
  ...
  return await response.json();
          ...
          { type: 'note', title: 'API Access', text: 'To use the Frami API, you need to register for an API key through the developer portal. API usage is subject to rate limits based on your subscription tier.' }
        ]
      },
      {
        ...
        content: [
          ...
          { type: 'warning', title: 'Enforcement', text: 'Violations of the code of conduct may result in warnings, temporary suspension, or permanent removal from the platform, depending on the severity and context of the violation.' },
          ...
          { type: 'table', headers: ['Channel', 'Purpose', 'Link'], rows: [
            ['Discord', 'Real-time community discussions and support', 'discord.gg/frami'],
            ['Forum', 'Detailed discussions, proposals, and community governance', 'forum.frami.io'],
            ['GitHub', 'Code contributions, issue tracking, and technical discussions', 'github.com/frami-platform'],
            ['Developer Chat', 'Technical support for developers building on Frami', 'dev.frami.io/chat'],
            ['Twitter', 'Platform announcements and updates', 'twitter.com/FramiPlatform'],
            ['Help Center', 'Knowledge base with guides and troubleshooting', 'help.frami.io']
          ]}
        ]
      },
      {
        ...
        content: [
          ...
          { type: 'subheading', title: 'What happens if I lose access to my wallet?' },
